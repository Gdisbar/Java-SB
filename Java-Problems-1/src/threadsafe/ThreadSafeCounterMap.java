...
class ThreadSafeCounter {
    ...
    // protected threadsafe.ThreadSafeCounter(Object item){
    // 	this.item = item;
...
class ThreadSafeCounterMap{
	public static void main(String[] args) {
		// threadsafe.ThreadSafeCounter th1 = new threadsafe.ThreadSafeCounter("item-1");
		// threadsafe.ThreadSafeCounter th2 = new threadsafe.ThreadSafeCounter("item-2");
		// threadsafe.ThreadSafeCounter th3 = new threadsafe.ThreadSafeCounter("item-3");
